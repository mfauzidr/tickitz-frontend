    ...
    <main className="font-mulish pt-16 pb-20 px-4 md:px-52 lg:px-[450px] bg-neutral-100">
      <section className="self-center px-5 md:px-10 py-10 bg-white rounded-md">
        ...
        <div className="flex flex-col mt-7">
          ...
          <div className="pl-3 py-3 text-sm mt-3 tracking-wider bg-white rounded border-b-[2px] border-solid border-neutral-200" defaultValue={UserInfo?.phone_number  ? `${UserInfo.phone_number}` : "N/A"}>
