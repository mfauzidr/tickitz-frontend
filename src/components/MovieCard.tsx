                    ...
                    <div key={index} className="flex flex-col w-full">
                        <div className="flex flex-col items-start w-full tracking-wider">
                            ...
                            >
                                ...
                                />
                                {isHovered === index && (<div className="absolute inset-0 flex flex-col justify-center px-4 sm:px-10 py-8 sm:py-36 rounded-md bg-black bg-opacity-40">
                                    <div className="flex flex-col w-full">
                                        <button className="gap-1.5 self-stretch px-3 sm:px-5 py-2 sm:py-3 w-full text-white whitespace-nowrap rounded-md border border-white border-solid">
                                            Details
                                        </button>
                                        <button className="gap-1.5 self-stretch px-3 sm:px-5 py-2 sm:py-3 mt-3 w-full bg-blue-700 rounded-md text-slate-50">
                                            Buy Ticket
                                        </button>
                                    </div>
                                </div>)}
